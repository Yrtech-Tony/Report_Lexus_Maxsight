...
public class CommonHandler
{
    ...
    public static void DBConnect()
    {
        ...
        if (conn == null)
        {
            ...
            conn.ConnectionString = "Provider=sqloledb;Data Source=123.57.229.128;Initial Catalog=DSATReport;user id=DSATReport;pwd=!@dsat;";
    ...
    public static DataSet query(string sql)
    {
        ...
        string ConnectionString = "Provider=sqloledb;Data Source=.;Initial Catalog=LEXUSReport_Mystery;user id=sa;pwd=mxT1@mfb;";
